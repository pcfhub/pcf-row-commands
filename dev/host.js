...
(function (root, factory) {
     ...
     * control does rather than like a list of resx keys.
     *
     * Taken from `RowCommands/strings/RowCommands.1033.resx`, which is the only
     * copy that matters — `npm run check` holds the other four to the same key
     * set, and `dev/smoke.js` deliberately does NOT use these: it passes a
     * `getString` that returns `resx:<key>`, so an assertion can tell a string
     * that came from the resx apart from one hardcoded in the source. This
     * table is for the eye; that one is for the assertions.
     */
    var STRINGS = {
        RowCommands_Commands: "Commands",
        RowCommands_CommandsFor: "Commands for {0}",
        RowCommands_Delete: "Delete",
        RowCommands_DeleteCancel: "Cancel",
        RowCommands_DeleteCancelled: "Nothing was deleted.",
        RowCommands_DeleteConfirm: "Delete",
        RowCommands_DeleteFailed: "{0} could not be deleted.",
        RowCommands_DeleteRecord: "Delete {0}",
        RowCommands_DeleteText: "{0} will be deleted permanently. This cannot be undone.",
        RowCommands_DeleteTitle: "Delete this record?",
        RowCommands_Deleted: "{0} was deleted.",
        RowCommands_Empty: "No records.",
        RowCommands_Error: "This view could not be loaded.",
        RowCommands_Launch: "Open link",
        RowCommands_LaunchUrl: "Open the link on {0}",
        RowCommands_Loading: "Loading records…",
        RowCommands_Next: "Next page",
        RowCommands_NoColumns: "No columns are selected for this table.",
        RowCommands_Open: "Open",
        RowCommands_OpenFailed: "That record could not be opened.",
        RowCommands_OpenRecord: "Open {0}",
        RowCommands_PageStatus: "Page {0}",
        RowCommands_Previous: "Previous page",
